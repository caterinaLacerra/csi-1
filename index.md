...
<div id="myModal_c" class="caterina">
  <!-- Modal content -->
...
### Reference <button id="button_ref" class="btn" onclick="document.getElementById('myModal_c').style.display = block"><i class="far fa-bookmark"></i></button>
