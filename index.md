...
### Reference <form action="https://www.w3docs.com/" method="get" target="_blank">
 <button id="button" class="btn" onclick="href = 'https://w3docs.com'" target="_blank"><i class="far fa-bookmark"></i></button>
 </form>
